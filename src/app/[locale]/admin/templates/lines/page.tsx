...
import { listTemplateLineAssets } from "@/lib/admin/template-assets/service";
...
export default async function AdminTemplateLinesPage({
  params
}: {
  ...
  return (
    <AdminTemplateElementAssetsManagement
      initialAssets={await listTemplateLineAssets()}
