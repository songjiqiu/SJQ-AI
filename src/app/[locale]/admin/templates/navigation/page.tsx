...
import { listTemplateNavigationAssets } from "@/lib/admin/template-assets/service";
...
export default async function AdminTemplateNavigationPage({
  params
}: {
  ...
  return (
    <AdminTemplateElementAssetsManagement
      initialAssets={await listTemplateNavigationAssets()}
