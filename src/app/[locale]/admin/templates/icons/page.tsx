...
import { listTemplateIconAssets } from "@/lib/admin/template-assets/service";
...
export default async function AdminTemplateIconsPage({
  params
}: {
  ...
  return (
    <AdminTemplateElementAssetsManagement
      initialAssets={await listTemplateIconAssets()}
